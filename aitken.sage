...
def aitken(g, x0, tol=10^-6):
    """
    Implementación del método de Aitken para hallar raíces de una función.
    ---------------------------------------------
    ...
    while (err >= tol):
        ...
        x0 = xn2  # para la siguiente iteración del punto fijo
        x_ant = x_sig
    return x_sig
